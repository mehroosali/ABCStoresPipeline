...
import main.scala.ABCFunctions.read_schema
...
object DailyDataIngestAndRefine {
  def main(args: Array[String]): Unit = {
    ...
    val landingFileSchemaFromFile = config.getString("schema.landingFileSchema")
    val holdFileSchemaFromFile = config.getString("schema.holdFileSchema")
    ...
    val prevDayZoneSuffix = "_" + yesterday.format(DateTimeFormatter.ofPattern("ddMMyyyy"))
